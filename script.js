...
bucketColorBtn.addEventListener('change', () => {
  ...
  console.log('Color Vaalue is:', bucketColor);
  createCanvas();
  restoreCanvas();
});
...
clearStorageBtn.addEventListener('click', () => {
  ...
  activeToolEl.style.letterSpacing = '0';
  switchToBrushDelay(DELAY_TIME);
});
